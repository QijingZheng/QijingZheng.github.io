...
# nac = np.sum(V5 * np.matmul(Hderv, V6[...,None])[:,:,0], axis=1) / (E6 - E5)
...
ax.plot(rr, E3, lw=0.5, ls='-', color='r') #label=r'$\varepsilon_1^a$')
ax.plot(rr, E4, lw=0.5, ls='-', color='b') #label=r'$\varepsilon_2^a$')
...
plt.savefig('num_nac_noorder.png')
# plt.show()

from subprocess import call
call('feh -xdF num_nac_noorder.png'.split())
